...
def set_value(
    ...
    Raises:
        Exception: exception
        ValueError: in errors is list of list [[key,val],...]
...
def merge(
    ...
    Returns:
        dictsource,errors : if die=False then will return errors, the list has the keys which were in dictupdate but not in dictsource
