...
quote10 = quote_model.create_obj({
        "author": "Milton Berle",
...
redis = db_model.create_obj({
    'host': 'localhost',
    'user': {
         'username': 'omar',
         'password': 'omar password'
        }
    })
